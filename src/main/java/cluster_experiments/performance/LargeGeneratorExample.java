package cluster_experiments.performance;
...
public class LargeGeneratorExample {
    public static final int AMOUNT_OF_ROWS = 5_000_000;
    public static final String FILE_NAME = "/home/zaleslaw/data/ds_" + AMOUNT_OF_ROWS + ".txt";
